## Purpose
Define the responsive web application shell for navigating calculator experiences across screen sizes while preserving dedicated, non-intrusive ad regions.
